...
export default function PortalHome() {
  ...
  return <>
    {c.blockReason && <div className="blk" style={{ borderColor: "var(--er)", background: "var(--er-bg)" }}><div style={{ fontSize: 13.5, fontWeight: 700, color: "var(--er)", marginBottom: 4 }} className="hi">खाता अस्थायी रूप से रोका गया है</div><div style={{ fontSize: 12.5, color: "var(--er)" }} className="hi">{c.blockReason} — बकाया चुकाने पर रोक अपने आप हट जाएगी। खाता और भुगतान खुला है।</div></div>}
