...
import { CustomerForm } from "@/components/CustomerDetail";
import type { Customer } from "@/components/types";
import { exportCsv } from "@/lib/csv";
import { Icon } from "@/components/icons";

export default function CustomersPage() {
  const { line } = useAppState(); const { can } = useAuth(); const { openModal } = useUI(); const sp = useSearchParams(); const router = useRouter();
  ...
  useEffect(() => { const o = sp.get("open"); if (o) router.replace(`/customers/${o}`); }, [sp, router]);
