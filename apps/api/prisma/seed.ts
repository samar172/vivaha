...
const LINES = [
  ...
  { id: "L3", code: "signage", name: "Flex & ACP", nameHi: "फ़्लेक्स व ACP", icon: "🪧", color: "#4338CA", bg: "#EEF0FE", uom: "SQ.FT", packUoms: ["Sheet", "Roll"], minSetQty: 200, holdMins: 45, gstPct: 18, stockDims: ["lot"], batchTracked: false, pricingModel: "AREA", workflow: "FULFIL", facets: ["material", "thickness", "finish"], sortOrder: 3 },
  { id: "L4", code: "jobwork", name: "Job Work", nameHi: "जॉब वर्क", icon: "🖨️", color: "#15803D", bg: "#ECFDF3", uom: "JOB", packUoms: [], minSetQty: 0, holdMins: 0, gstPct: 18, stockDims: [], batchTracked: false, pricingModel: "QUOTE", workflow: "JOBWORK", facets: ["process", "colours"], sortOrder: 4 },
] as const;
const GODOWNS = [
...
const RAW_CUST: RawCust[] = [
  ...
  ["Golden Invites Bikaner", "Arif Khan", "Distributor", "Bikaner", 500000, 45, "WARN", "golden_invites", ["L1", "L2", "L3", "L4"], [["Offset", { colours: "4", ink: "Sicpa", company: "Ryobi 524", roller: "720 mm", chem: "Varn", industry: "Commercial Printing" }], ["Flex", { company: "Konica", model: "KM-512i", ink: "Solvent" }], ["UV", { company: "Sunlite", model: "UV-40" }]]],
  ...
  ["Suryodaya Cards Jodhpur", "Naveen Choudhary", "Dealer", "Jodhpur", 250000, 45, "WARN", null, ["L1", "L2", "L3"], [["Offset", { colours: "2", ink: "SGL", company: "Heidelberg GTO 46", roller: "620 mm", chem: "Varn", industry: "Wedding Stationery" }], ["Flex", { company: "Allwin", model: "E-180", ink: "Eco-Solvent" }]]],
  ...
  ["Churu Card Traders", "Deepak Ranga", "Regular", "Churu", 130000, 30, "WARN", null, ["L1", "L3"], [["Flex", { company: "Konica", model: "KM-512i", ink: "Solvent" }]]],
